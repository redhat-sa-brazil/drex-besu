...
vsphere:
	...
	ansible-playbook --extra-vars "@vars.yml" --extra-vars "storage_class=thin" --extra-vars "service=service.beta.kubernetes.io/aws-load-balancer-type" --extra-vars loadbalancer="external" playbooks/deploy_besu.yml
